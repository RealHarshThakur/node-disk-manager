...
//+kubebuilder:rbac:groups=blockdevice.openebs.io,resources=blockdevices,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=blockdevice.openebs.io,resources=blockdevices/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=blockdevice.openebs.io,resources=blockdevices/finalizers,verbs=update

// Reconcile is part of the main kubernetes reconciliation loop which aims to
// move the current state of the cluster closer to the desired state.
// TODO(user): Modify the Reconcile function to compare the state specified by
// the BlockDevice object against the actual cluster state, and then
// perform operations to make the cluster state reflect the state specified by
// the user.
//
// For more details, check Reconcile and its Result here:
// - https://pkg.go.dev/sigs.k8s.io/controller-runtime@v0.7.2/pkg/reconcile
func (r *BlockDeviceReconciler) Reconcile(request ctrl.Request) (ctrl.Result, error) {
